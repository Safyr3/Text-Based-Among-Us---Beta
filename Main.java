...
public class Main
{
  ...
  public static void main(String[] args)
  {
    ...
    if(role % 2 != 0 || name.equals("luci"))
    {
      ...
      Imposter imposter = new Imposter(name, numberOfPeople, isImposter, isCrewmate);
    ...
    else if (role % 2 == 0 || name.equals("jack"))
    {
      boolean isImposter = false;
      boolean isCrewmate = true;

      Crewmate crewmate = new Crewmate(name, numberOfPeople, isImposter, isCrewmate);
      ...
      while(numberOfPeople >= 1)
      {
        ...
        else if(task.equals("no"))
        {
          ...
          Meeting meeting = new Meeting(name, numberOfPeople, 0, false, isImposter, isCrewmate);
        }
        else
        {
          System.out.println();
